...
func defaultRules() []RuleConfig {
	show := true
	return []RuleConfig{
		{ID: "rule-firewall-block-forward", Enabled: true, SourceType: "firewall", Asset: "*", Category: "*", Severity: "*", Operation: "*", EventType: "*", MessageContains: "firewall_block", Action: "store_and_forward", SampleRate: 1, ForwardToDMZ: true, StoreLocally: true, ShowInUI: &show, Notes: "Forward firewall blocks before generic noise controls"},
		{ID: "rule-firewall-reject-forward", Enabled: true, SourceType: "firewall", Asset: "*", Category: "*", Severity: "*", Operation: "*", EventType: "*", MessageContains: "firewall_reject", Action: "store_and_forward", SampleRate: 1, ForwardToDMZ: true, StoreLocally: true, ShowInUI: &show, Notes: "Forward firewall rejects before generic noise controls"},
		...
		{ID: "rule-firewall-pass-sample", Enabled: true, SourceType: "firewall", Asset: "*", Category: "*", Severity: "*", Operation: "*", EventType: "*", MessageContains: "firewall_pass", Action: "sample", SampleRate: 0.02, ForwardToDMZ: false, StoreLocally: true, ShowInUI: &show, DedupWindowSeconds: 10, RateLimitPerSecond: 25, Notes: "Aggressively sample OPNsense pass logs before generic error forwarding"},
		{ID: "rule-firewall-filterlog-noise-sample", Enabled: true, SourceType: "firewall", Asset: "*", Category: "*", Severity: "*", Operation: "*", EventType: "*", MessageContains: "filterlog", Action: "sample", SampleRate: 0.02, ForwardToDMZ: false, StoreLocally: true, ShowInUI: &show, DedupWindowSeconds: 10, RateLimitPerSecond: 25, Notes: "Sample raw OPNsense filterlog noise even when parser category/severity is imperfect"},
		{ID: "rule-error-forward", Enabled: true, SourceType: "*", Asset: "*", Category: "*", Severity: "error", Operation: "*", EventType: "*", Action: "store_and_forward", SampleRate: 1, ForwardToDMZ: true, StoreLocally: true, ShowInUI: &show, Notes: "Forward non-firewall errors"},
		...
		{ID: "rule-firewall-catchall-sample", Enabled: true, SourceType: "firewall", Asset: "*", Category: "*", Severity: "*", Operation: "*", EventType: "*", Action: "sample", SampleRate: 0.05, ForwardToDMZ: false, StoreLocally: true, ShowInUI: &show, DedupWindowSeconds: 10, RateLimitPerSecond: 50, Notes: "Final firewall safety valve: sample/store only unmatched firewall chatter"},
